...
function HomePage() {
  ...
  const { VFPara, VFStyledSpan, VFMainHeading, VFSubPara, MDltv, VFWeightHeading, MDWeightCap, VFPickup, PickupWeightCap, VFrickshaw, RickshawWeightCap } = t ("VFleet");
  const { faqHeading, faqSubPara } = t("FAQ");
  const { DloadMainheading, DloadSubPara } = t("DownloadSection");
  const { NLmainheading, NLsubPara, emailPlaceholder, subButton, inputSubPara } = t("NLsection")
  return (
    <div>
      {/* Hero Section */}
          ...
          <div className="max-w-[1280px] flex flex-wrap gap-[20px]">
            <div className="flex flex-wrap justify-center gap-[6px]">
              <div className="w-[154px] h-[169px] flex flex-col gap-[8px] p-[30px] items-center bg-lightBlue border-solid border-1 border-forBorder rounded-[16px]">
                ...
                <p className="font-ManropeSB text-sm text-center">{TWMfmcg}</p>
              </div>
              ...
              <div className="w-[154px] h-[169px] flex flex-col gap-[8px] p-[30px] items-center bg-lightBlue border-solid border-1 border-forBorder rounded-[16px]">
                <img
                  ...
                  alt=""
                />
                <p className="font-ManropeSB text-sm text-center">{TWMagri}</p>
              </div>

              <div className="w-[154px] h-[169px] flex flex-col gap-[8px] p-[30px] items-center bg-lightBlue border-solid border-1 border-forBorder rounded-[16px]">
                <img src={SteelIcon} className="w-[64px] h-[64px]" alt="" />
                <p className="font-ManropeSB text-sm text-center">{TWMSteel}</p>
              </div>
              ...
              <div className="w-[154px] h-[169px] flex flex-col gap-[8px] p-[30px] items-center bg-lightBlue border-solid border-1 border-forBorder rounded-[16px]">
                <img
                  ...
                  alt=""
                />
                <p className="font-ManropeSB text-sm text-center">{TWMconst}</p>
              </div>

              <div className="w-[154px] h-[169px] flex flex-col gap-[8px] p-[30px] items-center bg-lightBlue border-solid border-1 border-forBorder rounded-[16px]">
                <img src={CoalIcon} className="w-[64px] h-[64px]" alt="" />
                <p className="font-ManropeSB text-sm text-center">{TWMcoal}</p>
              </div>
              <div className="w-[154px] h-[169px] flex flex-col gap-[8px] p-[30px] items-center bg-lightBlue border-solid border-1 border-forBorder rounded-[16px]">
                <img src={OilIcon} className="w-[64px] h-[64px]" alt="" />
                <p className="font-ManropeSB text-sm text-center">{TWMoil}</p>
              </div>
              ...
              <div className="w-[154px] h-[169px] flex flex-col gap-[8px] p-[30px] items-center bg-lightBlue border-solid border-1 border-forBorder rounded-[16px]">
                ...
                <p className="font-ManropeSB text-sm text-center">{TWMPaper}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col px-[16px] text-3xl font-ManropeSB items-center">
            {i18n.language === "en" ? (
              ...
              <div>
                <p className="flex flex-col text-3xl font-ManropeSB items-center text-center">
                  {VFMainHeading}
                  <div className="relative font-ClashDisplayMedium before:block before:absolute before:bg-primary before:h-[18px] before:w-[41px] before:bottom-[-4px] before:right-[28px] before:z-[-1]"></div>
                </p>
              </div>
            )}
          </div>
          ...
          <div className="max-w-[1280px] flex flex-wrap justify-center gap-[20px]">
            <div className="flex flex-wrap justify-center gap-[20px]">
              <div className="w-[386px] h-[408px] flex flex-col justify-center items-center gap-[24px] p-[30px] items-left bg-white border-solid border-1 border-forBorder rounded-[16px]">
                ...
                <div className="flex flex-col gap-[6px]">
                  <p className="font-ManropeSB text-lg">{MDltv}</p>
              ...
              <div className="w-[386px] h-[408px] flex flex-col justify-center items-center gap-[24px] p-[30px] items-left bg-white border-solid border-1 border-forBorder rounded-[16px]">
                ...
                <div className="flex flex-col gap-[6px]">
                  <p className="font-ManropeSB text-lg">{VFPickup}</p>
                  <p className="flex gap-[8px]">
                    <span className="font-ManropeBold text-[16px]">
                      {VFWeightHeading}
                    </span>
              ...
              <div className="w-[386px] h-[408px] flex flex-col justify-center items-center gap-[24px] p-[30px] items-left bg-white border-solid border-1 border-forBorder rounded-[16px]">
                ...
                />
                <div className="flex flex-col gap-[6px]">
                  <p className="font-ManropeSB text-lg">{VFrickshaw}</p>
                  <p className="flex gap-[8px]">
                    <span className="font-ManropeBold text-[16px]">
                      {VFWeightHeading}
                    </span>
        ...
        <div>
          <div className="flex flex-col text-3xl font-ManropeSB items-center">
            <p className="text-center">
              ...
              <div>
                <p className="flex flex-col text-3xl font-ManropeSB items-center text-center">
                  <span className="relative font-ClashDisplayMedium before:block before:absolute before:bg-primary before:h-[13px] before:w-full before:bottom-[-1px] before:right-0 before:z-[-1]">
                {faqHeading}
              </span>
                </p>
              </div>
