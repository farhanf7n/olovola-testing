  ...
  return (
    <div className="bg-secondary py-[71px]">
      <div className="max-w-[1280px] mx-auto flex flex-col h-full justify-center items-center">
        ...
        <div className="flex flex-col items-start justify-between pt-10 mt-10 border-t border-gray-100 md:flex-row md:items-center w-full">
          <p className="mb-6 text-left font-ManropeRegular text-white text-[16px] md:mb-0">
